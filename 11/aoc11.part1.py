...
#   print(checkSeatincomingGrid[coord[0]][coord[1]])     
   adjacentList = []
   try:
      adjacentList.append(checkSeatincomingGrid[coord[0]-1][coord[1]-1])
      adjacentList.append(checkSeatincomingGrid[coord[0]-1][coord[1]])
      adjacentList.append(checkSeatincomingGrid[coord[0]-1][coord[1]+1])
      adjacentList.append(checkSeatincomingGrid[coord[0]][coord[1]-1])
      adjacentList.append(checkSeatincomingGrid[coord[0]][coord[1]+1])
      adjacentList.append(checkSeatincomingGrid[coord[0]+1][coord[1]-1])
      adjacentList.append(checkSeatincomingGrid[coord[0]+1][coord[1]])
      adjacentList.append(checkSeatincomingGrid[coord[0]+1][coord[1]+1])
